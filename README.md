...
DisplayLayoutが動作しているとき、**Win+Alt+Endキー** でDisplayLayoutウィンドウがアクティブになります。アクティブなとき数字キーとメニューキー（Appキー）を受け付けます。
...
モニターが選択された状態で数字キーを押すと対応した入力コネクタに切り替わります。この状態で、メニューキー（Appキー）で右クリックメニューを表示させることも可能です。

数字と入力コネクタの対応は、右クリックメニューと同じで、1から始まる数字を使います。
